                ...
                spec["text_layers"].append(
                    {
                        ...
                        "font_size": text_overlay.get("font_size", {}).get(
                            "main", "72pt"
                        ),
    ...
    with open(guide_file, "w", encoding="utf-8") as f:
        ...
        for concept in concepts_list:
            ...
            if "sub" in text_overlay:
                ...
                f.write(
                    f"- Size: {text_overlay.get('font_size', {}).get('sub', '36pt')}\n\n"
                )
            ...
            if (
                "person" in str(visual_elements).lower()
                or "face" in str(visual_elements).lower()
            ):
                steps.extend(
                    [
        ...
        f.write("## 🔍 A/B Testing\n\n")
        f.write(
            "**Recommendation:** Create 2-3 different thumbnails and test which gets higher CTR\n\n"
        )
    ...
    with open(links_file, "w", encoding="utf-8") as f:
        ...
        templates = [
            (
                ...
                "https://www.canva.com/templates/?query=youtube+thumbnail",
            ),
            (
                "Meditation Thumbnail",
                "https://www.canva.com/templates/?query=meditation+thumbnail",
            ),
            (
                "Minimal Thumbnail",
                "https://www.canva.com/templates/?query=minimal+youtube+thumbnail",
            ),
        ]
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate Canva thumbnail templates and guides"
    )
    parser.add_argument(
        "--input-dir",
        type=Path,
