...
class ThumbnailGeneratorAI:
    ...
    def generate_base_image(self, concept: dict) -> str | None:
        ...
        try:
            ...
            print("🎨 Generating base image with DALL-E...")
    ...
    def _build_dalle_prompt(self, concept: dict) -> str:
        ...
        # Base prompt
        prompt = "Create a YouTube thumbnail for a Thai Buddhist Dhamma channel. "
    ...
    def add_text_overlay(
        self, base_image: str, concept: dict, output_path: Path
    ) -> bool:
        ...
        try:
            ...
            if concept.get("badge_text"):
                ...
                badge_bbox = draw.textbbox(
                    (badge_x, badge_y), badge_text, font=font_badge
                )
                padding = 20
                draw.rounded_rectangle(
                    [
                        badge_bbox[0] - padding,
                        badge_bbox[1] - padding,
                        badge_bbox[2] + padding,
                        badge_bbox[3] + padding,
                    ],
                    radius=10,
                    fill=(255, 183, 77, 230),
                )
    ...
    def generate(self, output_path: Path, concept_index: int = 0) -> bool:
        ...
        if success:
            ...
            print("=" * 70)
            print(f"\n📄 File: {output_path}")
            print("📏 Size: 1280x720 (YouTube standard)")
...
def main():
    ...
    parser.add_argument(
        "--output", required=True, help="Output thumbnail file (PNG/JPG)"
    )
