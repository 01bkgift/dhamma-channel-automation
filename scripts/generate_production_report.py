...
def generate_html_report(run_id: str, base_dir: Path) -> str:
    ...
    if topics_ranked and "topic_override" in topics_ranked:
        ...
        topics_ranked and "ranked" in topics_ranked and len(topics_ranked["ranked"]) > 0
    ):
    ...
    # Second priority: voiceover_guide
        ...
        if any(
            "duration_seconds" in section for section in voiceover_guide["sections"]
        ):
            total_seconds = sum(
                section.get("duration_seconds", 0)
                for section in voiceover_guide["sections"]
            )
            minutes = int(total_seconds // 60)
            seconds = int(total_seconds % 60)
            duration = f"{minutes}:{seconds:02d} นาที"
    ...
    section_count = (
        len(list(sections_dir.glob("*.txt"))) if sections_dir.exists() else 0
    )
...
<body>
    <div class="container">
        ...
        "exists" if sections_dir.exists() else "missing"
                        ...
                        <a href="file:///{
        abs_audio
    }" class="btn btn-success">เปิดโฟลเดอร์ Audio</a>
        ...
        "exists" if editing_guide["exists"] else "missing"
                        ...
                        <a href="file:///{
        abs_template
    }" class="btn btn-success">เปิดโฟลเดอร์ Templates</a>
                ...
                <div class="step">
                    ...
                    <div class="step-content">
                        ...
                        <div class="file-list">
                            <div class="file-item {
        "exists" if canva_guide["exists"] else "missing"
    }">
                        ...
                        <a href="file:///{
        abs_canva
    }" class="btn btn-success">เปิดโฟลเดอร์ Canva</a>
                ...
                <div class="step">
                    ...
                    <div class="step-content">
                        ...
                        <div class="file-list">
                            <div class="file-item {
        "exists" if script_file["exists"] else "missing"
    }">
                        ...
                        <a href="file:///{
        abs_output / "metadata.json"
    }" class="btn btn-secondary">เปิด metadata.json</a>
        ...
        <div class="footer">
            ...
            <p>Generated by Production Orchestrator • {
    ...
    <script>
        ...
        async function generateTTS(e) {{
            ...
            try {{
                ...
                const scriptPath = String.raw`{
        str(abs_audio / "recording_script_SIMPLE.txt").replace(chr(92), chr(92) * 2)
    }`;
                const outputPath = String.raw`{
        str(abs_audio / "voiceover_ai.mp3").replace(chr(92), chr(92) * 2)
    }`;
                ...
                const batchPath = String.raw`{
        str(abs_audio / "run_tts.bat").replace(chr(92), chr(92) * 2)
    }`;
                // Performance logging instrumentation
                const perfLog = String.raw`{
        str(abs_audio / "performance_log.txt").replace(chr(92), chr(92) * 2)
    }`;
                let batchLines = [];
...
def main():
    ...
    print("✅ สร้าง HTML Report เรียบร้อย!")
    print(f"   📄 {report_file}")
