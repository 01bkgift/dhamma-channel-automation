...
class MonitoringWorkflow:
    ...
    def save_step(self, step_num, agent_name, data):
        ...
        json_file = (
            self.output_dir
            / f"step_{step_num:02d}_{agent_name.lower().replace(' ', '_')}.json"
        )
    ...
    def step_06_personalization(self):
        result = {
            "personalized_recommendations": ["วิดีโอสมาธิสำหรับวัยรุ่น", "คลิปสั้นสำหรับผู้สูงอายุ"],
    ...
    def step_07_user_feedback_collector(self):
        result = {
            ...
            "positive": 36,
            "negative": 6,
            "top_comments": ["คลิปนี้ดีมาก เข้าใจง่าย", "อยากได้เนื้อหาเรื่องกรรมเพิ่ม"],
        }
    ...
    def step_09_auto_labeling(self):
        result = {"auto_tags": ["สมาธิ", "ธรรมะ", "ฝึกใจ", "ปล่อยวาง"], "accuracy": "92%"}
