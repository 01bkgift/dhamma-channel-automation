# ROADMAP — FlowBiz Client Dhamma

> **📘 Blueprint (Single Source of Truth)**: สำหรับภาพรวมโครงการ ขอบเขต และกฎหลักที่ต้องไม่ละเมิด โปรดดู [/BLUEPRINT.md](/BLUEPRINT.md)

เอกสารนี้แสดงแผนงานพัฒนาระบบ FlowBiz Client Dhamma แบบ **PR-based development** โดยแบ่งเป็น Core Track (PR1–PR11), Extension Track (PR-2.2–PR-2.4) และ Future Vision (PR12+)
...
ระบบ FlowBiz Client Dhamma ออกแบบตามหลักการสำคัญดังนี้:
