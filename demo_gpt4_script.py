    ...
    try:
        response = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "คุณคือนักเขียนสคริปต์วิดีโอธรรมะมืออาชีพ ที่สามารถอธิบายธรรมะให้เข้าใจง่าย น่าสนใจ และเชื่อมโยงกับชีวิตจริง",
                },
        ...
        # บันทึก JSON
        json_file = (
            output_dir / f"script_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
        )
