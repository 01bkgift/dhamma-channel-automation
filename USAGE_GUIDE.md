...
```
d:\FlowBiz\flowbiz-client-dhamma\
│
...
2. TopicPrioritizer - จัดอันดับหัวข้อ ✅
3. ResearchRetrieval - ค้นคว้าข้อมูล
4. CommunityInsight - วิเคราะห์ feedback
5. GrowthForecast - ทำนาย growth
6. AdvancedBI - วิเคราะห์ข้อมูลลึก

### Phase 3: Content Creation (10 agents) 🟡

18. ScriptOutline - สร้างโครงสร้าง ✅
2. ScriptWriter - เขียนสคริปต์ ✅
3. DoctrineValidator - ตรวจสอบหลักธรรม
4. Localization - แปลภาษา
5. SEOMetadata - สร้าง title/description/tags
6. PersonalizationAgent - ปรับ content ตาม audience
7. DataEnrichment - เพิ่มข้อมูลเสริม
8. VisualAutomation - สร้าง visual/graphics (ยังไม่มี)
9. AudioGeneration - สร้าง voiceover (ยังไม่มี)
10. FormatConversion - แปลง format (MP4, shorts, etc)

### Phase 4: Publishing (5 agents)

28. MultiChannelPublish - อัพโหลด YouTube/Facebook/TikTok
2. SchedulingPublish - จัดตารางเผยแพร่
3. AutoLabeling - ติด tags อัตโนมัติ
4. DataSync - ซิงค์ข้อมูล
5. FeedbackLoop - รับ feedback

### Phase 5: Analytics (4 agents)

33. AnalyticsRetention - วิเคราะห์ retention
2. DashboardAgent - สร้าง dashboard
3. UserFeedbackCollector - รวบรวม feedback
4. ExperimentOrchestrator - จัดการ A/B tests
